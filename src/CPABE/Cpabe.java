...
public class Cpabe {
	...
	public String Message(){
		System.out.println("we are good python!!!");
		return "we are good python!!!";
	}
	...
	public void delegate(String pubfile, String prvfile, String file_attr) {
...
//			System.exit(0);
	...
	public String simplify_policy(String policy, String file_attr) throws Exception{
		String out = Bswabe.simplify_policy(policy, file_attr);
		return out;
	}
