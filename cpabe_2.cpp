...
bswabe_prv_t* bswabe_keygen( bswabe_pub_t* pub, bswabe_msk_t* msk, vector<string> attributes )
{
	bswabe_prv_t* prv;
	element_t g_r;
	element_t r;
	...
	for(int i=0; i<attributes.size(); i++)
	{
		...
		element_t h_rp;
		element_t rp;
        char * tt = (char *)malloc(sizeof(char)*attributes[i].size());
...
int main(){
    ...
    vector<string> attrs;
    attrs.push_back("name:kamal");
    attrs.push_back("age:20");
